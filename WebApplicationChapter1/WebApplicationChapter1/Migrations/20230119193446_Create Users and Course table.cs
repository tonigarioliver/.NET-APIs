...
{
    /// <inheritdoc />
    public partial class CreateUsersandCoursetable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortCourseDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    LongCourseDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
